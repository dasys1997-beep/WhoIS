...
у такому форматі:
{
  "name": "ім'я персонажа, якщо вказано в тексті явно, інакше null",
  "description": "ПЕРЕКАЗ своїми словами, 2-4 короткі речення, без цитування оригіналу",
  "suggestedField": "одне з: description, events — чи це більше про ХТО персонаж (характер, зовнішність, риси) чи про ЩО він робив/де був (дія, подія)",
...
ВАЖЛИВО про name: повертай ім'я ТІЛЬКИ якщо воно явно написане в тексті
на фото. Якщо текст говорить "він", "вона", "детектив" без імені —
обов'язково поверни null, НЕ вигадуй і не вгадуй ім'я з контексту.
